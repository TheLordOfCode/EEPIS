...
@section('content')
    <div id="content">
        <div id="content-header">
            <div id="breadcrumb"> <a href="{{ url('/home') }}" title="ir a Inicio" class="tip-bottom"><i class="icon-home"></i> Inicio</a> <a href="{{ url('/home/settings') }}" title="ir a configurar" class="tip-bottom"><i class="icon icon-cog"></i>Configurar</a>  </div>
